...
import { bestSellersSamples } from '../lib/sampleData';
...
const BestSellers = () => {
  ...
  const sampleProducts: Product[] = useMemo(() => bestSellersSamples, []);
  ...
  if (loading) {
    return (
      <section id="best-sellers" className="py-16 px-4 bg-white">
                ...
                >
                  <Link to={`/product/${product.id}`}>
                    <div className="relative overflow-hidden group/image">
                      ...
                      <div className="absolute top-3 left-3 bg-yellow-400 text-gray-800 px-3 py-1 rounded-full text-xs font-bold">
                        BEST SELLER
                      </div>
                  ...
                  <div className="p-4">
                    ...
                    {/* Sold row removed to match CategoryPage style */}
